...
> **Planning only - no code.** Implementation gated on founder signing [ADR-0007](../adr/0007-redb-storage-engine.md).
...
- **Depends on:** P3-T01
- **Files:** `docs/adr/0007-redb-storage-engine.md`, `.hive/memory/decisions.jsonl`
...
---
*Each task is build-ready; implementation starts only after ADR-0007 is signed.*