...
| Last updated | 2026-06-13 (PM dispatch v239 — PR #841 MERGED `2b6e842` (PM v237+v238 chore, CI 20/20 ✅, Codex P2 fixed `0020a24`); escalation ×98→×99) |
...
## Dispatch state (2026-06-13 v239)

| Agent | Status | Current item |
|---|---|---|
| founder | **🚨 action required (P0 ×2 + P1 ×1)** | **(1) READY**: PR #568 CI 50/50 ✅ (×99 runs) — trigger `finalize` workflow_dispatch → advances main to v0.3.0 + likely fixes issue #829 mutation kill rate. **(2) UNBLOCKED**: PR #763 — un-draft + merge RFC-0121 Charter §2 amendment (×99 consecutive escalations for PR #568). |
| PM | **DONE ✅** | v239: PR #841 merged `2b6e842` (PM v237+v238 chore, 20/20 CI ✅, Codex P2 fixed `0020a24`); escalation ×98→×99; PM state v239 written. |
