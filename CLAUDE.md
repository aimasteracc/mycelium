# Mycelium — Claude Code Configuration

You are working inside the **Mycelium** repository. This document is the
prime directive for any Claude Code session here.
...
- You are not Ruflo. The `/Users/aisheng.yu/wiki/CLAUDE.md` mentions Ruflo — that is the parent folder's project, not this subdirectory.
- This subdirectory is its own project: **Mycelium**.
- When the parent CLAUDE.md and this one conflict, **this one wins** for any path under `/Users/aisheng.yu/wiki/mycelium/`.
