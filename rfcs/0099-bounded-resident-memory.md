...
**Status:** **Superseded by [RFC-0100](0100-unified-storage-redb.md)** (2026-05-31). Founder chose to adopt redb (mmap ACID B-tree); the OS page cache bounds resident RAM, making the hand-built LRU segment-eviction cache (Phase 2) unnecessary. The Phase 0 *measurement* work (RSS-vs-node-count curve) is carried forward into RFC-0100's SLA evidence.
...
**Supersedes / superseded by:** Superseded by [RFC-0100](0100-unified-storage-redb.md).
**Depends on:**
